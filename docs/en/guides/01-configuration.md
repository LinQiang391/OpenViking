...
| `max_concurrent` | int | Maximum number of concurrent embedding requests (default: `10`, set at `embedding` level) |
...
| `max_concurrent` | int | Maximum number of concurrent VLM calls (default: `100`) |
