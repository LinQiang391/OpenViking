...
The script will: 1) validate the OpenViking runtime environment, 2) install OpenClaw and OpenViking, 3) run the setup helper to configure and deploy the memory plugin.
